...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="JavaScript"
			src="${applicationScope.rootpath}scripts/formcheck.js"></script>
		<!-- play -->
		<script type="text/javascript" src="${applicationScope.rootpath}scripts/play/swfobject.js"></script>
		<script type="text/javascript" src="${applicationScope.rootpath}scripts/play/1bit.js"></script>
		<script type="text/javascript" src="${applicationScope.rootpath}scripts/play/player.js"></script>
		<style type="text/css">
#header {
	height: 60px
}
...
<script type="text/javascript">
	...
	<!-- 呼入弹屏 -->
<script language="javascript" for="Phone" event="OnUserCallIN(strANI,strDNIS,strAcdSplit,strUCID)" type="text/javascript">
	navTab.openTab("addOrderinfoCardNav", "addWorkOrder.action?callinno="
				+ strANI + "&factorymenu=1&ordersource=callin&ucid="+strUCID+"&agentid=${workNo}", {
			title : "来电工单",
			fresh : true,
			data : {}
			});
	...
	<!-- 外呼弹屏 -->
	<script  language="javascript" for="Phone" event="OnRingOutbound(strUCID,strCalled)" type="text/javascript" >
	navTab.openTab("addOrderinfoCardNav", "addWorkOrder.action?callinno="
				+ strCalled + "&factorymenu=1&ordersource=callout&ucid="+strUCID+"&agentid=${workNo}", {
			title : "外呼工单",
			fresh : true,
			data : {}
			});
