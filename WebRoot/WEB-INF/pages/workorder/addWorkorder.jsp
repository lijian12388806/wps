	...
	<div class="lcp_div_left" style="width: 100%;">
		<div class="lcp_div_left" style="margin-top: 10px; width: 50%;">
			<table class="list" nowrapTD="false" width="98%"
				...
				<tbody>
					<tr>
						<c:set value="${workOrderForm.generatemode}" var="ordersource"/>
			...
			<table class="list" nowrapTD="false" width="98%"
				...
				<tbody>
					<tr>
						...
						<td align="left" width="80%">
							<input name="workOrderForm.customerno"
								id="workOrderForm.customerno"
								value="${workOrderForm.customerno}" maxlength="50" type="text"
					...
					<tr>
						...
						<td align="left" width="80%">
							<select name="workOrderForm.temp2" class=""
								lookupGroup="workOrderForm">
								<option value="">
									<s:text name="common.listbox" />
								</option>
								<c:forEach items="${applicationScope.dictpara['Gender']}"
									var="activeState">
									<c:choose>
										<c:when test="${workOrderForm.temp2 == activeState.code}">
											<option value="${activeState.code}" selected>
												${activeState.title}
											</option>
										</c:when>
