...
<form id="pagerForm" method="post"
	...
	<input type="hidden" value="${querytemp1}" id="querytemp1"
		name="querytemp1">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ListCustomerinfo.action?search=true" method="post"
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>
						QQ号码:
						<input name="querytemp1" type="text" id="querytemp1" size="15"
							style="WIDTH: 94px" value="${querytemp1}" onkeydown="" />
					</td>
					<td>
						邮箱地址:
		...
		<ul class="toolBar">
			<li>
				<a class="add"
					...
					rel="addCustomerCardNav" target="navTab" reloadFlag=1><span>新增客户信息</span>
				</a>
			</li>
			<li class="line">
				line
			...
			<li>
				<a class="edit"
				href="${applicationScope.rootpath}ListCusphonelist.action?customerKey={slt_uid}"
				rel="cusphonelistCardNav" target="navTab" reloadFlag=1 width="813" height="400"><span>客户联系人
			</a>
			</li>
			<!-- <li>
