		...
		<tbody>
			<c:forEach var="item" items="${sessionScope.customerinfoList}">
				<tr target="slt_uid" rel="${item.id}">
					<td>
						<a class=""
							href="javascript:$.bringBack({isnew:'false',customerid:'${item.id}',customerno:'${item.custlinkman}',customername:'${item.customername}', custlinkman:'${item.custlinkman}', temp2:'${item.temp2}', custphoneno:'${item.custphoneno}',temp1:'${item.temp1}',emailaddr:'${item.emailaddr}',netherlands:'${item.netherlands}',custaddr:'${item.custaddr}'})"
